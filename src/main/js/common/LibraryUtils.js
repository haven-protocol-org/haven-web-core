...
class LibraryUtils {
   ...
   * a web worker (defaults to "/HavenWebWorker1.0.70.dist.js").
   * 
   * @param {string} workerDistPath - path to load HavenWebWorker1.0.70.dist.js
   */
...
LibraryUtils.WORKER_DIST_PATH_DEFAULT = "/HavenWebWorker1.0.70.js";
