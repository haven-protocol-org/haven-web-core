...
class LibraryUtils {
  ...
  //  LibraryUtils.WASM_MODULE = require("../../../../dist/haven_offshore1.4.55_keys")();
  ...
  static async loadCoreModule() {
    ...
    // load module
    delete LibraryUtils.WASM_MODULE;
    LibraryUtils.WASM_MODULE = require("../../../../dist/haven_offshore1.4.55")();
    return new Promise(function(resolve, reject) {
      LibraryUtils.WASM_MODULE.then(module => {
        LibraryUtils.WASM_MODULE = module
        delete LibraryUtils.WASM_MODULE.then;
  ...
  /**
   * Set the path to load HavenWebWorker1.4.55.dist.js when running this library in
   * a web worker (defaults to "/HavenWebWorker1.4.55.dist.js").
   * 
   * @param {string} workerDistPath - path to load HavenWebWorker1.4.55.dist.js
   */
...
LibraryUtils.WORKER_DIST_PATH_DEFAULT =  "./HavenWebWorker1.4.55.js";
